...
var prefix = configs.Config.Handler.Prefix

// Message creae event
func init() {
	fmt.Println("[INFO] prefix commands event Registered")
	discord.Session.AddHandler(func(session *discordgo.Session, message *discordgo.MessageCreate) {
